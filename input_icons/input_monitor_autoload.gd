...
func _input(event: InputEvent) -> void:
	...
	match event.get_class():
		# Events generated by emulate_mouse_from_touch have device == -1
		"InputEventKey", "InputEventMouseButton" when event.device != -1:
			new_input_type = InputType.KEYBOARD_AND_MOUSE
		"InputEventMouseMotion" when event.device != -1:
