...
var options: Array[Option] = [
	preload("options/float/ui_scale.gd").new(),
	preload("options/enum/vsync.gd").new(),
	preload("options/float/max_fps.gd").new(),
	preload("options/bool/fullscreen.gd").new(),
	preload("options/bool/fps_counter.gd").new(),
	preload("options/float/camera_fov.gd").new(),
	preload("options/float/3d_scale.gd").new(),
	...
	preload("options/float/fsr_sharpness.gd").new(),
